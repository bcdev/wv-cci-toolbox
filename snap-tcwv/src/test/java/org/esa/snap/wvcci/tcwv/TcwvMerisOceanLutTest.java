...
//        final NetcdfFile ncFile = TcwvIO.getTcwvLookupTableNcFile(auxdataPath, "ocean_core_meris.nc4");
    ...
    private void testTcwvLutMetadata_ocean(List<Attribute> globalAttributes, List<Dimension> dimensions, List<Variable> variables) {
        ...
        assertEquals("cha_14_cwvl", globalAttributes.get(12).getFullName());
        assertEquals(884.676, (Double) globalAttributes.get(12).getValue(0), 1.E-3);
        assertEquals("cha_15_nominal", globalAttributes.get(13).getFullName());
        assertEquals(900.0, globalAttributes.get(13).getValue(0));
        assertEquals("cha_15_bwvl", globalAttributes.get(14).getFullName());
        assertEquals(5.901237351371007, globalAttributes.get(14).getValue(0));
...
//        assertEquals(2, dimensions.get(9).getLength());
    ...
    private void testTcwvLutContent_ocean(List<Variable> variables) {
        try {
            ...
            assertEquals(-1.0451481684687043, aotArray[2], 1.E-6);
            assertEquals(-0.012549792619642362, aotArray[5], 1.E-6);
            ...
            assertEquals(0.017598, jlutArray[2][4][6][3][2][7][1], 1.E-6);
            ...
            assertEquals(0.001415, jlutArray[3][0][3][6][7][2][1], 1.E-6);
