...
public class TcwvFullAlgoForOneLandPixelMain {

    /**
     * Actually this does the same as unit tests in TcwvFullAlgoForOneLandPixelTest
     *
     * @param args -
     * @throws IOException -
     */
    public static void main(String[] args) throws IOException {
        computeLand_modis_terra();
        computeLand_meris();
    }

    private static void computeLand_meris() throws IOException {
        // represents test in test_cawa.py --> test_cawa_land_meris() in wv-cci-parent_se_only
        ...
        System.out.println("Result land MERIS: " + result.getTcwv());  // we get 7.1699
        // Python result: 7.1699 --> exactly matching
    }

    private static void computeLand_modis_terra() throws IOException {
        // represents test in test_cawa.py --> test_cawa_land_modis_terra() in wv-cci-parent_se_only
        ...
        System.out.println("Result land MODIS TERRA: " + result.getTcwv());  // we get 6.51
