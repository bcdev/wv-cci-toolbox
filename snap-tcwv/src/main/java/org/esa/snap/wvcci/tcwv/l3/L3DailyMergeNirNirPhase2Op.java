 ...
 * @author Olaf Danne
 */
@OperatorMetadata(alias = "ESACCI.Tcwv.L3.Merge.Nir.Nir.Phase2", version = "0.8",
        authors = "O.Danne",
        internal = true,
        description = "Operator for merge of TCWV L3 NIR daily products, for Phase 2.")
public class L3DailyMergeNirNirPhase2Op extends PixelOperator {
    ...
    public static class Spi extends OperatorSpi {
        ...
        public Spi() {
            super(L3DailyMergeNirNirPhase2Op.class);
        }
    }
}
