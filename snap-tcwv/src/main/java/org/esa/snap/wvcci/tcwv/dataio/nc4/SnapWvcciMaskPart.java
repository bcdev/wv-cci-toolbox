...
/**
 * Modification of BeamMaskPart for WV_cci purposes
 *
 * @author olafd
 */
public class SnapWvcciMaskPart extends BeamMaskPart {

    private static final String WVCCI_MASK_PREFIX = "wvcci";
    ...
    private static void writeMasks(Product p, NFileWriteable ncFile) throws IOException {
        ...
        for (String maskName : maskNames) {
            if (maskName.startsWith(WVCCI_MASK_PREFIX)) {
