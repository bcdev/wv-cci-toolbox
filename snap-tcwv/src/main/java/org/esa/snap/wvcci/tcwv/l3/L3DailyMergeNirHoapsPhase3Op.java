...
/**
 * Operator for sensor merging of TCWV L3 products of unlimited (currently up to 5) sensors.
 * We have MERIS, MODIS_T, MODIS_A, OLCI_A, OLCI_B (land) and HOAPS SSM/I (water).
 * <p>
 * <p/>
 *
 * @author Olaf Danne
 */
@OperatorMetadata(alias = "ESACCI.Tcwv.L3.Merge.Nir.Hoaps.Phase3", version = "0.8",
        authors = "O.Danne",
        internal = true,
        description = "Operator for merge of TCWV L3 NIR and HOAPS daily products, for Phase 2.")
public class L3DailyMergeNirHoapsPhase3Op extends PixelOperator {
    ...
    public static class Spi extends OperatorSpi {
        ...
        public Spi() {
            super(L3DailyMergeNirHoapsPhase3Op.class);
        }
    }
}
