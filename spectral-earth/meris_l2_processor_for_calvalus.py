...
def doit():
    ...
    if l1_name.lower().endswith('nc'):
        ...
        data = cowa.cowa_meris_io_nc.get_relevant_l1l2_data(ds_l1, DEMO_CONFIG, cmi=True)
    else:
    ...
    cowa.cowa_meris_io_nc.write_to_ncdf_cci(tcwv_name, out, start_date_string, stop_date_string)
