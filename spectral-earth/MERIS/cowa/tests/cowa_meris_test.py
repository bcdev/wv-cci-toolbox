...
class TestCowaMeris(unittest.TestCase):
    ...
    def test_clean_list(self):
        s_list = ['MOD021KM.A2015196.1830.061.2017321064215.hdf',
                  'MOD021KM.A2015196.1835.061.2017321123456.hdf',
                  'MOD021KM.A2015196.1835.061.2017321234567.hdf',
                  'MOD021KM.A2015196.1840.061.2017321345678.hdf',
                  'MOD021KM.A2015196.1845.061.2017321456789.hdf',
                  'MOD021KM.A2015196.1850.061.2017321567890.hdf',
                  'MOD021KM.A2015196.1850.061.2017321678912.hdf',
                  'MOD021KM.A2015196.1855.061.2017321789123.hdf',
                  'MOD021KM.A2015196.1900.061.2017321890123.hdf']

        # new list shall have the double entries 1835 , 1850 removed:
        cleaned_list = self.get_cleaned_list(s_list)
        print(cleaned_list)
        self.assertEqual(7, len(cleaned_list))
        self.assertEqual('MOD021KM.A2015196.1830.061.2017321064215.hdf', cleaned_list[0])
        self.assertEqual('MOD021KM.A2015196.1835.061.2017321123456.hdf', cleaned_list[1])
        self.assertEqual('MOD021KM.A2015196.1840.061.2017321345678.hdf', cleaned_list[2])
        self.assertEqual('MOD021KM.A2015196.1845.061.2017321456789.hdf', cleaned_list[3])
        self.assertEqual('MOD021KM.A2015196.1850.061.2017321567890.hdf', cleaned_list[4])
        self.assertEqual('MOD021KM.A2015196.1855.061.2017321789123.hdf', cleaned_list[5])
        self.assertEqual('MOD021KM.A2015196.1900.061.2017321890123.hdf', cleaned_list[6])


    def get_cleaned_list(self, orig_list):
