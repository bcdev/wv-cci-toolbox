...
$SNAP_HOME/bin/gpt_cems ESACCI.MergeIdepixEraInterim -SidepixProduct=$idepixPath -SeraInterimProduct=$eramodis -Psensor=MODIS_TERRA -f Netcdf4-BEAM -t $idepixEraInterimMerge
...
# list results
echo "ERAINTERIM OUTPUT PRODUCT: $eramodis"
